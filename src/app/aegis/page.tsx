...
const CAPABILITIES: Capability[] = [
  ...
  { id: 11, name: "LLM Gateway & Circuit Breaker", status: "REAL", detail: "Real CLOSED/OPEN/HALF_OPEN state machine and token-bucket limiter, now aware of per-team limits.", caveat: "Single-process — a fleet needs Redis for shared counters." },
        ...
        <section className="py-20 md:py-28 border-b border-zinc-800/60">
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="flex flex-wrap gap-x-8 gap-y-3 mt-10 pt-6 border-t border-zinc-800/60 text-[11px] font-mono text-zinc-500">
              ...
              <span className="flex items-center gap-1.5"><KeyRound className="w-3.5 h-3.5 text-zinc-400" /> API keys + rate limits</span>
        ...
        <section className="py-16 md:py-20 border-b border-zinc-800/60">
          <div className="max-w-4xl mx-auto px-6">
            <SectionHeading
              ...
              sub="This is an engineering demonstration, not a product for sale or rent — the multi-tenant primitives below are real and tested, with nothing behind a paywall."
            />
            <div className="grid sm:grid-cols-3 gap-4">
              <div className="luxury-panel rounded-xl p-4 text-xs font-mono">
                <KeyRound className="w-4 h-4 text-[#d4af37] mb-2" />
                <div className="text-zinc-200 font-semibold mb-1">API Keys</div>
                <p className="text-zinc-500 leading-relaxed">SHA-256 hashed at rest, shown once on issuance, revocable — verified end to end, including rejecting a revoked key.</p>
              </div>
              <div className="luxury-panel rounded-xl p-4 text-xs font-mono">
                <ShieldCheck className="w-4 h-4 text-[#d4af37] mb-2" />
                <div className="text-zinc-200 font-semibold mb-1">Per-Tenant Rate Limits</div>
                <p className="text-zinc-500 leading-relaxed">Configurable requests/min, tokens/min, and spend budget per team — auth is opt-in, off by default, so the demo below needs no key.</p>
              </div>
              <div className="luxury-panel rounded-xl p-4 text-xs font-mono">
                <Database className="w-4 h-4 text-[#d4af37] mb-2" />
                <div className="text-zinc-200 font-semibold mb-1">Durable Spend</div>
                <p className="text-zinc-500 leading-relaxed">Cumulative spend is SQLite-backed and survives a process restart — proven by actually killing the process and checking the number again.</p>
              </div>
            </div>
          </div>
        </section>
